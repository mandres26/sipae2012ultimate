...
<%@page import="java.sql.SQLException,java.util.LinkedList,modelo.DiaFamilia, modelo.PresupuestoIngreso, modelo.Presupuesto, modelo.PresupuestoGastos, controlador.ManejadorDiaFamilia" session='true'%>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>CEDULA PRESUPUESTAL DE INGRESOS PARA EL DIA DE LA FAMILIA</title>
        <script type="text/javascript"  src="images/calculoPresupuestoDiaFamilia.js" charset="utf-8"></script>
    ...
    <body>
        <%
            ...
            try {
                LinkedList<DiaFamilia> listaImp = ManejadorDiaFamilia.listarPresupuestoDiaFamilia(idPresupuesto, idPreing);
                    DiaFamilia parvulo = new DiaFamilia();
                    DiaFamilia prejardin = new DiaFamilia();
                    DiaFamilia preescolar = new DiaFamilia();
                    DiaFamilia primero = new DiaFamilia();
                    DiaFamilia segundo = new DiaFamilia();
                    DiaFamilia tercero = new DiaFamilia();
                    DiaFamilia cuarto = new DiaFamilia();
                    DiaFamilia quinto = new DiaFamilia();
                    for (int i = 0; i < listaImp.size(); i++) {
                        DiaFamilia imp = new DiaFamilia();
                        if ((i + 1) <= listaImp.size()) {
                            imp = listaImp.get(i);
                            if (imp.getNivel().equals("parvulo")) {
                                parvulo = new DiaFamilia(imp);
                            }
                            imp = new DiaFamilia();
                        }
                        if ((i + 1) <= listaImp.size()) {
                        ...
                        if ((i + 1) <= listaImp.size()) {
                            ...
                            if (imp.getNivel().equals("quinto")) {
                                quinto = new DiaFamilia(imp);
                            }
                            imp = new DiaFamilia();
                        }
                    }
        %>
        <h3>CEDULA PRESUPUESTAL DE INGRESOS POR El DIA DE LA FAMILIA</h3>
