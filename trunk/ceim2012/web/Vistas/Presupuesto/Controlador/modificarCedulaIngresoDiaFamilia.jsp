    ...
    try {
        if (total == 0 || fecha == "" || descripcion == "") {
            ...
            if (presupuesto != null) {
                ...
                double valorAnt = subIMP + subCom + total;
            ...
            if (cantidad1 != 0 && valor1 != 0 && subtotal1 > 0) {
                fam = new DiaFamilia(id1,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel1, cantidad1, valor1, subtotal1);
                listaDiaFamilia.add(fam);
            }
            if (cantidad2 != 0 && valor2 != 0 && subtotal2 > 0) {
                fam = new DiaFamilia(id2,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel2, cantidad2, valor2, subtotal2);
                listaDiaFamilia.add(fam);
            }
            if (cantidad3 != 0 && valor3 != 0 && subtotal3 > 0) {
                fam = new DiaFamilia(id3,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel3, cantidad3, valor3, subtotal3);
                listaDiaFamilia.add(fam);
            }
            if (cantidad4 != 0 && valor4 != 0 && subtotal4 > 0) {
                fam = new DiaFamilia(id4,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel4, cantidad4, valor4, subtotal4);
                listaDiaFamilia.add(fam);
            }
            if (cantidad5 != 0 && valor5 != 0 && subtotal5 > 0) {
                fam = new DiaFamilia(id5,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel5, cantidad5, valor5, subtotal5);
                listaDiaFamilia.add(fam);
            }
            if (cantidad6 != 0 && valor6 != 0 && subtotal6 > 0) {
                fam = new DiaFamilia(id6,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel6, cantidad6, valor6, subtotal6);
                listaDiaFamilia.add(fam);
            }
            if (cantidad7 != 0 && valor7 != 0 && subtotal7 > 0) {
                fam = new DiaFamilia(id7,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel7, cantidad7, valor7, subtotal7);
                listaDiaFamilia.add(fam);
            }
            if (cantidad8 != 0 && valor8 != 0 && subtotal8 > 0) {
                fam = new DiaFamilia(id8,preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel8, cantidad8, valor8, subtotal8);
                listaDiaFamilia.add(fam);
            }
                ...
                for (int i = 0; (i + 1) <= tamList; i++) {
                    ...
                    try {
                        if (ManejadorDiaFamilia.existePresupuestoDiaFamilia(preing.getIdPresupuesto(), preing.getIdPresupuestoIngreso(), fam.getNivel())) {
                            ManejadorDiaFamilia.modificarPresupuestoDiaFamilia(fam);
                        } else {
                            ManejadorDiaFamilia.registrarPresupuestoDiaFamilia(fam);
                        }
                        j++;
                    } catch (SQLException ex) {
                        throw new SQLException("Al Modificar presupuesto del Dia de la Familia: " + ex.getMessage());
                    }
                }
                if (j == tamList) {
