    ...
    try {
        if (total == 0 || fecha == "") {
            ...
            if (cantidad1 != 0 && valor1 != 0 && subtotal1 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel1, cantidad1, valor1, subtotal1);
                listaDiaCometa.add(com);
            }
            if (cantidad2 != 0 && valor2 != 0 && subtotal2 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel2, cantidad2, valor2, subtotal2);
                listaDiaCometa.add(com);
            }
            if (cantidad3 != 0 && valor3 != 0 && subtotal3 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel3, cantidad3, valor3, subtotal3);
                listaDiaCometa.add(com);
            }
            if (cantidad4 != 0 && valor4 != 0 && subtotal4 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel4, cantidad4, valor4, subtotal4);
                listaDiaCometa.add(com);
            }
            if (cantidad5 != 0 && valor5 != 0 && subtotal5 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel5, cantidad5, valor5, subtotal5);
                listaDiaCometa.add(com);
            }
            if (cantidad6 != 0 && valor6 != 0 && subtotal6 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel6, cantidad6, valor6, subtotal6);
                listaDiaCometa.add(com);
            }
            if (cantidad7 != 0 && valor7 != 0 && subtotal7 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel7, cantidad7, valor7, subtotal7);
                listaDiaCometa.add(com);
            }
            if (cantidad8 != 0 && valor8 != 0 && subtotal8 > 0) {
                com = new DiaCometa(preing.getIdPresupuestoIngreso(), preing.getIdPresupuesto(), nivel8, cantidad8, valor8, subtotal8);
                listaDiaCometa.add(com);
            }
            ...
            if (tamList > 0) {
                ...
                if (j == tamList) {
                    presupuestoIngCompletadocom = 1;
                    preing.setCompletadocom(presupuestoIngCompletadocom);
                    String cpt = "<script type='text/JavaScript'>$('#regDiaCom').click();$('#finReg').show();</script>";
