     ...
     String id=request.getParameter("id");
             if(id!=null){
                 ...
                 if(ControlEstudiante.existeEstudiante(id)){
                     estudianteBusqueda=ControlEstudiante.consultarEstudiante(request.getParameter("id"));
    ...
    <div id="ajax">
        ...
        <table >
            ...
            <tbody>
                ...
                <tr>
                     <td>Identificacion:<br/><input type="text" name="id" value="<%=estudianteBusqueda.getVar_identificacion_estudiante()%>" />&nbsp;&nbsp;</td>
                    <td>Nombre:<br/><input type="text" name="nombre" id="nom" value="<%=estudianteBusqueda.getVar_nombres_estudiante()%>" />&nbsp;&nbsp;</td>
                    <td>Apellido<br/><input type="text" name="apellido" value="<%=estudianteBusqueda.getVar_apellidos_estudiante()%>" />&nbsp;&nbsp;</td>
               ...
               <tr>
                ...
                <tr>
                    <td>Nombre del Madre:<br/><input type="text" name="madre" value="" />&nbsp;&nbsp;</td>
                    <td>Nombre del Padre:<br/><input type="text" name="padre" value="" />&nbsp;&nbsp;</td>
                    <td>Direccion:<br/><input type="text" name="barrio" value="" />&nbsp;&nbsp;</td>
                </tr>
                <tr>
                    <td><br/></td>
                    <td><br/></td>
