...
-->
        ...
        <%
                ...
                String excusa=request.getParameter("excusar");
                 acudiente=ControladorAcudiente.consultarAcudiente(sessionUsuario.getIdUsuario());
          ...
          e=ControlEstudiante.consultarEstudiante(request.getParameter("id_estudiante"));
    ...
    <body>
        <form  name="formfecha" action="excusa.jsp">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                <input type="hidden" name="id_estudiante" value="<%=e.getVar_codigo_estudiante()%>" />
                        <td>Identificacion:<% out.print(e.getVar_codigo_estudiante());%></td>
                        <td><% //se optiene la identificacion del estudinte%></td>
                    </tr>
                    <tr>
                        <td>nombre:<% out.print(e.getVar_nombres_estudiante());%></td>
