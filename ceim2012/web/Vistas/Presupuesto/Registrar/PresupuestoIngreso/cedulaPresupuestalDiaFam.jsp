...
<%@page import="modelo.DiaFamilia, modelo.PresupuestoIngreso, modelo.Presupuesto, modelo.PresupuestoGastos, controlador.ManejadorDiaFamilia" session='true'%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <%            } else {%>
        <h4>El Ingreso del Dia de la Familia ya esta registrado. </h4>
        <%}
        } else {%>
