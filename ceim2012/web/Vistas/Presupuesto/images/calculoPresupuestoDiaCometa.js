        ...
        $("#form3").validationEngine('attach', {
            onValidationComplete: function(form, status) {
                ...
                if ($("#ttotal").val() == "") {
                    ...
                    if (status)
                        $("#result").load("Controlador/registrarCedulaIngresoDiaCometa.jsp",form.serialize()+"&fecha="+$("#fecha").val()+"&descripcion="+$("#descripcion").val());
                    else 
                        alert("Faltan datos.");
                }
            }
    ...
    ready:function(){
        ...
        $("#form3").validationEngine('attach', {
            onValidationComplete: function(form, status) {
                ...
                if (status)
                    $("#result").load("Controlador/modificarCedulaIngresoDiaCometa.jsp",form.serialize()+"&fecha="+$("#fecha").val()+"&descripcion="+$("#descripcion").val()+"&id="+$("#idpresupuesto").val()+"&idpreing="+$("#idpreing").val());
                else 
                    alert("Faltan datos.");
            }
        });
