...
<div id="content">
   ...
   <div id="main">
   <div id="welcome"><center> <b>Estudiantes</b></center> </div>          
    ...
    <div id="sidebar">
        ...
        <div id="updates" class="boxed">
			...
			<li>
                        ...
                        <h3>
                            <a href="#" onclick="inscripcion();sendRequest('GET','listadoInscripcion.jsp');">Inscribir Estudiante</a></h3></li><li>
			<h3>
